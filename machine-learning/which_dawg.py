# -*- coding: utf-8 -*-
"""
Created on Wed May 18 15:06:08 2016
...
scenes_location = dir_name = os.getcwd() + '/datasets/dogsDataset_pickleFile.pkl'
scenes_file = open(scenes_location, 'rb')
scenes = pickle.load(scenes_file)
scenes_file.close()

x_data = [v[0] for v in scenes]
y_data = [v[1] for v in scenes]
...
for i in range(10000):
   batch = mydata.train.next_batch(100)
   if i%10 == 0:
